...
namespace RTSim {
    ...
    void RTKernel::setEvtPriorityLevel(const int prio_lev)
    {
        beginDispatchEvt.setPriority(prio_lev + beginDispatchEvt.getPriority());
        endDispatchEvt.setPriority(prio_lev + endDispatchEvt.getPriority());
    }
